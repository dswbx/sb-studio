   ...
   (
      ...
      const button = (
         <Comp
            ...
            className={cn(
               sidebarMenuButtonVariants({ variant, size, hasIcon }),
               className
            )}
            {...props}
         />
